...
erpnext.PointOfSale.ItemSelector = class {
	...
	get_items({ start = 0, page_length = 40, search_term = "" }) {
		...
		return frappe.call({
			method: "erpnext.selling.page.integro_pos.point_of_sale.get_items",
			freeze: true,
	...
	get_item_groups() { 
		...
		return frappe.call({ 
			//method: "erpnext.selling.page.integro_pos.point_of_sale.item_group_query", 
	...
	make_search_bar() {
		...
		this.item_group_field = frappe.ui.form.make_control({
			df: {
				...
				get_query: function () {
					return {
						query: "erpnext.selling.page.integro_pos.point_of_sale.item_group_query",
						filters: {
	...
	bind_events() {
		...
		this.$component.on("click", ".item-group-button", function () {		
			...
			me.$item_groups_container.find(".item-group-button").css("color", "#1273FF")

			$item.css("background-color", "#1273FF") 
