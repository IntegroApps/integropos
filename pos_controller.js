erpnext.PointOfSale.Controller = class {
	...
	fetch_opening_entry() {
		return frappe.call("erpnext.selling.page.integro_pos.point_of_sale.check_opening_entry", {
	...
	create_opening_voucher() {
		...
		const dialog = new frappe.ui.Dialog({
			...
			primary_action: async function ({ company, pos_profile, balance_details }) {
				...
				const method = "erpnext.selling.page.integro_pos.point_of_sale.create_opening_voucher";
	...
	async prepare_app_defaults(data) {
		...
		frappe.call({
			method: "erpnext.selling.page.integro_pos.point_of_sale.get_pos_profile_data",
		...
		this.payment = new erpnext.PointOfSale.Payment({
			...
			events: {
				...
				delete_invoice_after_mp: (name) =>{
					frappe.model.delete_doc_after_mp(this.frm.doc.doctype, name, () => {
